...
返回JSON（仅JSON）：
{
  "summary": "一段200字以上的判词。从命宫${d.mainStar||''}入手，说出这个人灵魂的底色。不说星曜解释——用感受和场景描述他是哪种人。他可能是那种'在别人吵闹的房间里一个人安静看着窗外'的人，也可能是'明明很累了还要笑着说我没事'的人。说对了比说全了更重要。",
  "career": "一段200字以上的事业分析。从财帛宫和官禄宫出发。不说'适合XX职业'——说他赚钱的手感、在职场里最累的地方、什么时候该发力什么时候该等一等。如果他的星曜组合比较辛苦，告诉他辛苦不是因为他不够好。",
  "relationship": "一段180字以上的感情分析。从夫妻宫出发。说他在感情里最容易在什么类型的关系里受伤——不是因为他有缺陷，是因为他太擅长某件事（比如太会忍、太会照顾人），以至于对方忘了他也需要被照顾。他真正需要的是什么样的伴侣。",
  "health": "一段150字以上的健康建议。从疾厄宫出发，结合倪海厦《人纪》。说说情绪跟身体之间的那条暗线——比如'你在压力大的时候胃会不舒服，不是巧合'。给宜和忌各两条，具体到能立刻做。"
}`,
...
第一个：生肖${a.zodiac||"?"}，五行日主属${a.element||"?"}，生于${a.year||"?"}年${a.month||"?"}月${a.day||"?"}日
第二个：生肖${b.zodiac||"?"}，五行日主属${b.element||"?"}，生于${b.year||"?"}年${b.month||"?"}月${b.day||"?"}日
